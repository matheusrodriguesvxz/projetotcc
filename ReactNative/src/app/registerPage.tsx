        ...
        <View className="h-full bg-white">
            ...
            <View className="bg-white rounded-[80] h-[80] top-[-50] w-full p-9" >
                ...
                <View className="absolute left-11 top-14">
                    <Text
                        style={{ fontFamily: "Poppins", fontWeight: "bold", color: "#760FFF", letterSpacing: 0.5, marginTop: 5, fontSize: 23 }}>
                        Criar Conta
                    </Text>

                    <TextInput className="mt-8 border-1 border-b-4 py-2 w-[315] border-purple-800   "
                        placeholder="Nome completo" placeholderTextColor="#909090"
                        style={{ fontFamily: "Poppins", fontWeight: "bold", color: "#000000", letterSpacing: 0.5, marginTop: 25, fontSize: 16, borderColor: "#760bFF" }} />

                    <TextInput className="mt-8 border-1 border-b-4 py-2 w-[315] border-purple-800   "
                        placeholder="E-mail" placeholderTextColor="#909090"
                        style={{ fontFamily: "Poppins", fontWeight: "bold", color: "#000000", letterSpacing: 0.5, marginTop: 25, fontSize: 16, borderColor: "#760bFF" }} />
                    ...
                    <TextInput className="mt-8 border-1 border-b-4 py-2 w-[315] border-purple-800   "
                        placeholder="Confirme sua senha" placeholderTextColor="#909090"
                        style={{ fontFamily: "Poppins", fontWeight: "bold", color: "#000000", letterSpacing: 0.5, marginTop: 25, fontSize: 16, borderColor: "#760bFF" }} />
