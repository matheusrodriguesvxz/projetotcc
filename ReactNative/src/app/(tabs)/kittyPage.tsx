...
export default function KittyPage() {
    return (
        <>
            <SafeAreaView style={{ backgroundColor: "#760BFF", height: "30%", borderRadius: 50, marginBottom: 4, position:'relative', bottom:10 }}>

                <View>
                    <Progress.Bar progress={0.8} width={250} height={12} color="white" style={{ marginLeft: 20, marginTop: 20 }} />
            ...
            <View>
                <View className="flex justify-center items-center ">
                    <Pressable className="w-96 bg-black h-14 rounded-3xl justify-center" >
                        <Text className="text-white text-center " style={{
                            fontFamily: "Poppins",
                            fontWeight: "600",
                            fontSize: 16,
                            color: "white"
                        }}>Exportar chave PIX</Text>
                    </Pressable>
                </View>
